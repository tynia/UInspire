...
{
public:
   typedef void ( TObj::*TFunc )( INSPIRE_CLIENT::IUIWnd*, const INSPIRE_CLIENT::EventArg& );
   struct closure
   {
      TObj*   _Obj;
      TFunc   _Func;
   ...
   virtual void Invoke( INSPIRE_CLIENT::IUIWnd* wnd, const INSPIRE_CLIENT::EventArg& arg )
   {
...
inline void InitControl( TObj* obj, TWnd*& wnd, INSPIRE_CLIENT::IUIWnd* parentWnd,
...
{                                                                             \
public:                                                                       \
   typedef void ( TObj::*TFunc )( INSPIRE_CLIENT::IUIWnd*,                    \
                                  const INSPIRE_CLIENT::EventArg& );          \
...
FuncName( void (TObj::*func)( INSPIRE_CLIENT::IUIWnd*,                        \
                              const INSPIRE_CLIENT::EventArg& ) )             \
{                                                                             \
...
InitControl(this, btnOK, mainWnd, "btnOK", SetPressFunc(OnbtnOK))
